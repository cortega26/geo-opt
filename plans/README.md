...
| [091](archive/091-correct-default-model-documentation.md) | Make normative current docs consistently name v2 as default | docs | P2 | S | 085 | DONE (2026-08-10; executed in worktree — governance and architecture corrected to v2-default with v1 legacy/selectable, pending-switch language rewritten in past terms; 4 new invariant tests pin v2-default, scan current docs for v1-default contradictions, and keep Python v1-only + v2 experimental/non-predictive) |
