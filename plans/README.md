...
| [083](archive/083-close-symlink-write-escapes.md) | Route every Node/Python artifact destination through atomic symlink-safe writes | security | P1 | L | — | DONE (2026-08-09; merged to main as `876edbd`) |
