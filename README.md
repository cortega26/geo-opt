...
<p>
  ...
  <img src="https://img.shields.io/badge/tests-929_passed-16a34a?logo=nodedotjs&logoColor=white" alt="929 tests passed">
...
- **Engineered to ship.** 929 tests across 162 suites, CI on Node 22 & 24, TypeScript declarations verified by a consumer-compilation fixture, and an enforced changelog policy.
...
npm test               # 929 tests · 162 suites · 0 failures (Node.js)
