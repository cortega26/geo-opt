...
<p>
  ...
  <img src="https://img.shields.io/badge/tests-854_passed-16a34a?logo=nodedotjs&logoColor=white" alt="854 tests passed">
...
- **Engineered to ship.** 854 tests across 155 suites, CI on Node 22 & 24, TypeScript declarations verified by a consumer-compilation fixture, and an enforced changelog policy.
...
npm test               # 854 tests · 155 suites · 0 failures (Node.js)
