...
<p>
  ...
  <img src="https://img.shields.io/badge/tests-935_passed-16a34a?logo=nodedotjs&logoColor=white" alt="935 tests passed">
...
- **Engineered to ship.** 935 tests across 165 suites, CI on Node 22 & 24, TypeScript declarations verified by a consumer-compilation fixture, and an enforced changelog policy.
...
npm test               # 935 tests · 165 suites · 0 failures (Node.js)
