...
<p>
  ...
  <img src="https://img.shields.io/badge/tests-870_passed-16a34a?logo=nodedotjs&logoColor=white" alt="870 tests passed">
...
- **Engineered to ship.** 870 tests across 158 suites, CI on Node 22 & 24, TypeScript declarations verified by a consumer-compilation fixture, and an enforced changelog policy.
...
npm test               # 870 tests · 158 suites · 0 failures (Node.js)
