...
<p>
  ...
  <img src="https://img.shields.io/badge/tests-967_passed-16a34a?logo=nodedotjs&logoColor=white" alt="967 tests passed">
...
- **Engineered to ship.** 967 tests across 167 suites, CI on Node 22 & 24, TypeScript declarations verified by a consumer-compilation fixture, and an enforced changelog policy.
...
npm test               # 967 tests · 167 suites · 0 failures (Node.js)
