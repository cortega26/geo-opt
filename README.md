...
<p>
  ...
  <img src="https://img.shields.io/badge/tests-911_passed-16a34a?logo=nodedotjs&logoColor=white" alt="911 tests passed">
...
- **Engineered to ship.** 911 tests across 162 suites, CI on Node 22 & 24, TypeScript declarations verified by a consumer-compilation fixture, and an enforced changelog policy.
...
npm test               # 911 tests · 162 suites · 0 failures (Node.js)
