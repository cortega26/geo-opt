...
<p>
  ...
  <img src="https://img.shields.io/badge/tests-786_passed-16a34a?logo=nodedotjs&logoColor=white" alt="786 tests passed">
...
- **Engineered to ship.** 786 tests across 148 suites, CI on Node 22 & 24, TypeScript declarations verified by a consumer-compilation fixture, and an enforced changelog policy.
...
npm test               # 786 tests · 148 suites · 0 failures (Node.js)
