...
<p>
  ...
  <img src="https://img.shields.io/badge/tests-848_passed-16a34a?logo=nodedotjs&logoColor=white" alt="848 tests passed">
...
- **Engineered to ship.** 848 tests across 155 suites, CI on Node 22 & 24, TypeScript declarations verified by a consumer-compilation fixture, and an enforced changelog policy.
...
npm test               # 848 tests · 155 suites · 0 failures (Node.js)
