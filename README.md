...
<p>
  ...
  <img src="https://img.shields.io/badge/tests-983_passed-16a34a?logo=nodedotjs&logoColor=white" alt="983 tests passed">
...
- **Engineered to ship.** 983 tests across 167 suites, CI on Node 22 & 24, TypeScript declarations verified by a consumer-compilation fixture, and an enforced changelog policy.
...
```bash
npm run check          # full suite: lint + format + one JS test run (count/coverage badges) + Python + conformance + typecheck + changelog
npm test               # 983 tests · 167 suites · 0 failures (Node.js)
