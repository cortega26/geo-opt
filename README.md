...
<p>
  ...
  <img src="https://img.shields.io/badge/tests-758_passed-16a34a?logo=nodedotjs&logoColor=white" alt="758 tests passed">
...
- **Engineered to ship.** 758 tests across 112 suites, CI on Node 22 & 24, TypeScript declarations verified by a consumer-compilation fixture, and an enforced changelog policy.
...
npm test               # 758 tests · 112 suites · 0 failures (Node.js)
