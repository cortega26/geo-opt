...
<p>
  ...
  <img src="https://img.shields.io/badge/tests-782_passed-16a34a?logo=nodedotjs&logoColor=white" alt="782 tests passed">
...
- **Engineered to ship.** 782 tests across 147 suites, CI on Node 22 & 24, TypeScript declarations verified by a consumer-compilation fixture, and an enforced changelog policy.
...
npm test               # 782 tests · 147 suites · 0 failures (Node.js)
