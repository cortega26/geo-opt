...
<p>
  ...
  <img src="https://img.shields.io/badge/tests-862_passed-16a34a?logo=nodedotjs&logoColor=white" alt="862 tests passed">
...
- **Engineered to ship.** 862 tests across 155 suites, CI on Node 22 & 24, TypeScript declarations verified by a consumer-compilation fixture, and an enforced changelog policy.
...
npm test               # 862 tests · 155 suites · 0 failures (Node.js)
