...
<p>
  ...
  <img src="https://img.shields.io/badge/tests-933_passed-16a34a?logo=nodedotjs&logoColor=white" alt="933 tests passed">
...
- **Engineered to ship.** 933 tests across 162 suites, CI on Node 22 & 24, TypeScript declarations verified by a consumer-compilation fixture, and an enforced changelog policy.
...
npm test               # 933 tests · 162 suites · 0 failures (Node.js)
