...
<p>
  ...
  <img src="https://img.shields.io/badge/tests-937_passed-16a34a?logo=nodedotjs&logoColor=white" alt="937 tests passed">
...
- **Engineered to ship.** 937 tests across 167 suites, CI on Node 22 & 24, TypeScript declarations verified by a consumer-compilation fixture, and an enforced changelog policy.
...
npm test               # 937 tests · 167 suites · 0 failures (Node.js)
