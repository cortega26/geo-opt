...
<p>
  ...
  <img src="https://img.shields.io/badge/tests-967_pasados-16a34a?logo=nodedotjs&logoColor=white" alt="967 tests pasados">
...
Madurez: En riesgo
  El contenido muestra marcadores de estilo débiles con múltiples problemas de calidad en estructura, atribución y citas.
...
- ✅ **Diseñado para producción.** 967 tests en 167 suites, CI en Node 22 y 24, declaraciones TypeScript verificadas por una prueba de compilación de consumidor y una política de changelog aplicada automáticamente.
...
```bash
npm run check          # suite completa: lint + formato + una ejecución de tests JS (badges count/cobertura) + Python + conformance + typecheck + changelog
npm test               # 967 tests · 167 suites · 0 fallos (Node.js)
